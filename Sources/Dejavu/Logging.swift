...
internal func log(_ s: String, _ loggingCategory: LoggingCategory? = nil, type: OSLogType = .default, _ file: String = #file) {
    ...
    let category = loggingCategory != nil ? "[\(loggingCategory!)] - " : ""
